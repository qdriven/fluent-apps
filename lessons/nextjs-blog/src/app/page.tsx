...
export default function Home() {
  return (
    ...
    <h1>Hello, Next.js!</h1>
      <div>
        <div>
          <Link href={"/blog"} className={`bg-amber-100`}> Go to Blog Page </Link>
        </div>
        <div>
          <Link href={"/person"} className={`bg-amber-100`}> Go to Person Page </Link>
        </div>
        <div>
          <Link href={"/css"} className={`bg-amber-100`}> Go to Css Page </Link>
        </div>
        <div>
